...
schematic side-view of a Right Whale (*Eubalaena glacialis*).

There is no axis in this case, so at the stage of viewing, a scale has been set
...
the domain size.  The axes can be seen with the blue guiding lines (the '7' on
the y axis is a bit difficult to make out).
